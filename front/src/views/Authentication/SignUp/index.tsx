            ...
            <div className='sign-up-box'>
                ...
                <div className='sign-up-content-box'>
                    <div className='sign-up-content-sns-sign-in-box'>
                        <div className='sign-up-content-sns-sign-in-title'>{'SNS로그인'}</div>
                    ...
                    <div className='sign-up-content-input-box'>
                        ...
                        <InputBox ref={emailRef} title='이메일' placeholder='이메일주소를 입력해주세요.' type='text' value={email} onChange={onEmailChangeHandler} isErrorMessage={isEmailError} message={emailMessage} buttonTitle='이메일 확인' onButtonClick={onEmailButtonClickHandler} onKeyDown={onEmailKeyDownHandler}/>
